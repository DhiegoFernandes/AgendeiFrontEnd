...
import type { EvolucaoAnual } from '../types/user';

interface GraficoEvolucaoAnualProps {
  dados: EvolucaoAnual[];
}
...
export default function GraficoEvolucaoAnual({ dados }: GraficoEvolucaoAnualProps) {
  ...
  return (
    <ChartContainer
      xAxis={[{ scaleType: 'band', data: anos }]}
      series={[{ 
        type: 'bar', 
        id: 'faturamento', 
        data: faturamentos,
