import {
  FiUsers, FiBriefcase, FiClipboard, FiSettings, FiLogOut,
  FiMenu, FiX
} from "react-icons/fi";
      ...
      `}>
        ...
        <div className="sidebar-footer mt-auto">
          <div className="user flex items-center gap-2 py-3 pl-2 pr-0">
            <div className="avatar w-10 h-10 bg-purple-200 text-purple-700 flex items-center justify-center rounded-full font-bold">A</div>
            <div className="meta leading-tight hidden md:block">
              <strong>Admin</strong>
              <br /><small>admin@sistema.com</small>
            </div>
          </div>
          <a href="#" className="btn-logout flex items-center gap-2 px-3 py-2 bg-purple-600/40 hover:bg-purple-700 rounded transition mt-3 hidden md:flex">
            <FiLogOut />
            <span className="label font-bold">Sair</span>
          </a>
        </div>
      </aside>
